...
public class SftpConfig {
    ...
    @Bean
    @ServiceActivator(inputChannel = "ftp.ls.dir.recur")
    ...
    @Bean
    @ServiceActivator(inputChannel = "ftp.get.stream")
    ...
    @Bean
    @ServiceActivator(inputChannel = "ftp.put")
    ...
    @Bean
    @ServiceActivator(inputChannel = "ftp.rm")
