...
public class PublisherServiceImplTest {
    ...
    @Test
    public void testPublish_success() throws ResourceCollectionException, PublisherException {
        ...
        // when(utils.createDirResource(any(Resource.class), anyString())).thenReturn(fakeShareLocation);
